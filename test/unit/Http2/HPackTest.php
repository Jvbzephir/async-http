...
class HPackTest extends TestCase
{
    ...
    {
        $hpack = new class() extends HPack {

            public function encodeInt(int $int): string
            {
                return parent::encodeInt($int);
            }
        };
        
        $this->assertEquals(0b00001010, ord($hpack->encodeInt(10)));
    }
    ...
    public function testIntegerEncoding5BitPrefix2()
    {
        ...
        $encoded = $hpack->encodeInt(1337 - 31);
    ...
    public function testIntegerEncodingAtOctetBoundary()
    {
        ...
        $this->assertEquals(0b00101010, ord($hpack->encodeInt(42)));
    }
    ...
    {
        $context = new HPackContext(true, false);
        $context = $context->withIndex('custom-key');
    ...
    {
        $hpack = new HPack(new HPackContext(true, false));
    ...
    {
        $context = new HPackContext(true, false);
        $context = $context->withNeverIndexed('password');
    ...
    public function testMultipleRequestsWithHuffmanCoding()
    {
        ...
        $context = $context->withIndex(':authority');
        $context = $context->withIndex('cache-control');
        $context = $context->withIndex('custom-key');
